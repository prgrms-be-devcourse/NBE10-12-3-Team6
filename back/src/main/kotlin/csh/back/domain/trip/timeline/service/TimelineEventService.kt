...
class TimelineEventService(
    ...
    fun subscribe(tripGroupId: Long, memberId: Long): SseEmitter {
        ...
        emitters.computeIfAbsent(tripGroupId) {
    ...
    private fun sendTimelineUpdatedEvent(
        ...
        val tripEmitters = emitters[tripGroupId]
    ...
    private fun removeEmitter(tripGroupId: Long, emitter: SseEmitter) {
        val tripEmitters = emitters[tripGroupId] ?: return
        tripEmitters.remove(emitter)

        if (tripEmitters.isEmpty()) {
            emitters.remove(tripGroupId, tripEmitters)
        }
    }
