...
class TimelineV1Controller(
    ...
    fun createTimeline(
        ...
        return ResponseData(
            201,
            timelineService.createTimeline(tripId, memberId, request),
        )
    }
    ...
    fun createAllTimelines(
        ...
        return ResponseData(
            201,
            timelineService.createAllTimelines(tripId, memberId, request),
        )
    }
    ...
    fun getTimelines(
        ...
        return ResponseData(
            200,
            timelineService.getTimelines(tripId, memberId, dayNumber),
        )
    }
    ...
    fun getTimelineCounts(
        ...
        return ResponseData(
            200,
            timelineService.getTimelineCounts(tripId, memberId),
        )
    }
